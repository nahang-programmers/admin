...
class TopNav extends Component {
  ...
  handleLogout = () => {
    ...
    // this.props.logoutUser(this.props.history, this.state.user);
  };
  ...
  render() {
    ...
    return (
      <nav className="navbar fixed-top" style={{backgroundColor:"#d1c4e9"}}>
        ...
        {/*</a>*/}
        <img src={"./../../assets/img/nahang.png"} style={{marginRight:"48.5%",height:"65px"}}/>
          ...
          <div className="user d-inline-block">
            <UncontrolledDropdown className="dropdown-menu-right">
              <DropdownToggle className="p-0" color="empty">
                <span className="name ml-1">نهنگ</span>
                <span>
                  <img alt="Profile" src="/assets/img/nahang.png" />
                </span>
              </DropdownToggle>
              <DropdownMenu className="mt-3" right>
