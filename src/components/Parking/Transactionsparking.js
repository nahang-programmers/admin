...
class Transactionsparking extends React.Component {
    ...
    componentDidMount() {
        ...
        axios({
            method: 'get',
            url: api + "/admin/transactions/orderType/ParkingOrder",
...
export default Transactionsparking;
