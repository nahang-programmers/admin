...
class Brandscar extends React.Component {
    ...
    render() {
        ...
        const data = this.state.brands.map((items, key) => {
            return {name:items['name'], id:items['stateID']}
        });

        // const columns = ["کد برند", "نام برند"]

        const columns = [
            {title:"نام برند",field:"name"},
            {title:"کد برند",field:"id"}
        ]
